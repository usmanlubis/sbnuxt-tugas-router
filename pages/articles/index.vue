<template>
  <main class="container">
    <h4 class="text-center">Klik pada judul artikel</h4>
    <article v-for="article in articles" :key="article.title" class="mt-3">
      <h2><NuxtLink class="link text-decoration-none text-dark" :to="'/articles/detail/' + article.title">{{ article.title }}</NuxtLink></h2>
    </article>
  </main>
</template>
